        ...
        <div className="filtro">
            ...
            <form className="formFiltro" onSubmit={e => handleSubmit(e)}>
                <label className="label">
                    Sem Lactose
                    <input className="checkbox" type="checkbox" name="lactose" value={lactose} onChange={handleLactose}/>
                    <img className="simbolos" src={imgLactose}/>
                </label><br/>
                <label className="label">
                    Sem Glúten
                    <input className="checkbox" type="checkbox" name="gluten" value={gluten} onChange={handleGluten}/>
                    <img className="simbolos" src={imgGluten}/>
                </label><br/>
                <label>
                    Todas
                    <input className="checkbox" type="checkbox" name="todas" value={todas} onChange={handleTodas}/>
                </label>
                <b />
